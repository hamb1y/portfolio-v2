...
I planned out the new site with a black minimalistic theme and solid colors. It is also written in Astro but a much newer and non-unstable release of Astro. Instead of using something like bolt.dev which I used last time to code the old site, this time I was much more present in the creation process and used deepseek's deepseek-v3.2-thinking with opencode through the official API to make this site.
